...
00000000000010a0 <_start>:
    ...
    10c1:	48 8d 3d fc 00 00 00 	lea    0xfc(%rip),%rdi        # 11c4 <main>
...
0000000000001189 <func4>:
    1189:	f3 0f 1e fa          	endbr64 
    118d:	48 83 ec 08          	sub    $0x8,%rsp
    1191:	89 d0                	mov    %edx,%eax
    1193:	29 f0                	sub    %esi,%eax
    1195:	89 c1                	mov    %eax,%ecx
    1197:	c1 f9 1f             	sar    $0x1f,%ecx
    119a:	01 c8                	add    %ecx,%eax
    119c:	d1 f8                	sar    %eax
    119e:	8d 0c 06             	lea    (%rsi,%rax,1),%ecx
    11a1:	39 f9                	cmp    %edi,%ecx
    11a3:	74 0c                	je     11b1 <func4+0x28>
    11a5:	7d 0f                	jge    11b6 <func4+0x2d>
    11a7:	8d 51 ff             	lea    -0x1(%rcx),%edx
    11aa:	e8 da ff ff ff       	callq  1189 <func4>
    11af:	01 c0                	add    %eax,%eax
    11b1:	48 83 c4 08          	add    $0x8,%rsp
    11b5:	c3                   	retq   
    11b6:	8d 71 01             	lea    0x1(%rcx),%esi
    11b9:	e8 cb ff ff ff       	callq  1189 <func4>
    11be:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax
    11c2:	eb ed                	jmp    11b1 <func4+0x28>

00000000000011c4 <main>:
    11c4:	f3 0f 1e fa          	endbr64 
    11c8:	53                   	push   %rbx
    11c9:	48 83 ec 10          	sub    $0x10,%rsp
    11cd:	bb 28 00 00 00       	mov    $0x28,%ebx
    11d2:	64 48 8b 03          	mov    %fs:(%rbx),%rax
    11d6:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    11db:	31 c0                	xor    %eax,%eax
    11dd:	48 8d 74 24 04       	lea    0x4(%rsp),%rsi
    11e2:	48 8d 3d 1b 0e 00 00 	lea    0xe1b(%rip),%rdi        # 2004 <_IO_stdin_used+0x4>
    11e9:	e8 a2 fe ff ff       	callq  1090 <__isoc99_scanf@plt>
    11ee:	ba 0f 00 00 00       	mov    $0xf,%edx
    11f3:	be 00 00 00 00       	mov    $0x0,%esi
    11f8:	8b 7c 24 04          	mov    0x4(%rsp),%edi
    11fc:	b8 00 00 00 00       	mov    $0x0,%eax
    1201:	e8 83 ff ff ff       	callq  1189 <func4>
    1206:	89 c2                	mov    %eax,%edx
    1208:	48 8d 35 f8 0d 00 00 	lea    0xdf8(%rip),%rsi        # 2007 <_IO_stdin_used+0x7>
    120f:	bf 01 00 00 00       	mov    $0x1,%edi
    1214:	b8 00 00 00 00       	mov    $0x0,%eax
    1219:	e8 62 fe ff ff       	callq  1080 <__printf_chk@plt>
    121e:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    1223:	64 48 33 03          	xor    %fs:(%rbx),%rax
    1227:	75 0b                	jne    1234 <main+0x70>
    1229:	b8 00 00 00 00       	mov    $0x0,%eax
    122e:	48 83 c4 10          	add    $0x10,%rsp
    1232:	5b                   	pop    %rbx
    1233:	c3                   	retq   
