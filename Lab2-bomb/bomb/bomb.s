...
0000000000400da0 <main>:
  ...
  400e1e:	bf 38 23 40 00       	mov    $0x402338,%edi //"Welcome to my fiendish little bomb. You have 6 phases with"
  400e23:	e8 e8 fc ff ff       	callq  400b10 <puts@plt>
  400e28:	bf 78 23 40 00       	mov    $0x402378,%edi //"which to blow yourself up. Have a nice day!"
...
0000000000400efc <phase_2>:
  ...
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>  //arg1 = 1
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax  //int cur = *p, last = *(p - 4)
  400f1a:	01 c0                	add    %eax,%eax  
  400f1c:	39 03                	cmp    %eax,(%rbx)  
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>  //2 * last == cur ? continue : bomb
  400f25:	48 83 c3 04          	add    $0x4,%rbx  //p += 4
  400f29:	48 39 eb             	cmp    %rbp,%rbx  //p == end ? break : continue
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx //int* p = &arg2
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp  //int* end = &arg6
...
//1 311 or 2 707 or 3 256 or 4 389 or 5 206 or 6 682 or 7 327
0000000000400f43 <phase_3>:
  ...
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>  //input numbers > 1
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>  //arg1 <= 7
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8) //switch(arg1)
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax //arg2 == %eax 
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax  //int res = arg3;
  400fd4:	29 f0                	sub    %esi,%eax  //res -= arg2;
  400fd6:	89 c1                	mov    %eax,%ecx  //int tmp = res;
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx //tmp >>= 31;
  400fdb:	01 c8                	add    %ecx,%eax  //res += tmp; 
  400fdd:	d1 f8                	sar    %eax //res >>= 1;
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx //tmp = res + arg2
  400fe2:	39 f9                	cmp    %edi,%ecx  //return arg1 == tmp ? 0 : 
...
000000000040100c <phase_4>:
  ...
  401029:	83 f8 02             	cmp    $0x2,%eax  //input numbers == 2
  40102c:	75 07                	jne    401035 <phase_4+0x29>
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp) //15 <= arg1
  ...
  401048:	e8 81 ff ff ff       	callq  400fce <func4> //int res = func4(arg1, 0, 15)
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c>  //res == 0
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
  401056:	74 05                	je     40105d <phase_4+0x51>  //arg2 == 0
  401058:	e8 dd 03 00 00       	callq  40143a <explode_bomb>
  40105d:	48 83 c4 18          	add    $0x18,%rsp
  401061:	c3                   	retq   

//IONEFG(Not unique)
//  from "maduiersnfotvbyl" find 'f' 'l' 'y' 'e' 'r' 's'
//  whose index is                9   15  14  5   6   7
//  find a string with ascii: 0x_9 0x_f 0x_3 0x_5 0x_6 0x_7
//  where '_' can be arbitrarily chosen        
//  for example, consider plus 64(0x40)
//  the answer: IONEFG   <=>  0x49 0x4f 0x43 0x45 0x46 0x47                 
0000000000401062 <phase_5>:
  ...
  40107f:	83 f8 06             	cmp    $0x6,%eax  //input length == 6
  401082:	74 4e                	je     4010d2 <phase_5+0x70>
  401084:	e8 b1 03 00 00       	callq  40143a <explode_bomb>
  401089:	eb 47                	jmp    4010d2 <phase_5+0x70>//input: char* s;
                                                            //char* p; 
                                                            //for(int i = 0; i < 6; ++i){
  40108b:	0f b6 0c 03          	movzbl (%rbx,%rax,1),%ecx   //  char c = *(s + i); 
  40108f:	88 0c 24             	mov    %cl,(%rsp)           //  int t = c;
  401092:	48 8b 14 24          	mov    (%rsp),%rdx          
  401096:	83 e2 0f             	and    $0xf,%edx            //  t &= 0xf;
  401099:	0f b6 92 b0 24 40 00 	movzbl 0x4024b0(%rdx),%edx  //  t = "maduiersnfotvbyl" + t;
  4010a0:	88 54 04 10          	mov    %dl,0x10(%rsp,%rax,1)//*(p + i + 16) = t;
  4010a4:	48 83 c0 01          	add    $0x1,%rax            //}
  4010a8:	48 83 f8 06          	cmp    $0x6,%rax 
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>

  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)     //*(p + 16) = 0;
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi      //arg2 = "flyers";
  4010b8:	48 8d 7c 24 10       	lea    0x10(%rsp),%rdi     //arg1 = p + 16;
...
//4 3 2 1 6 5 
//  input six numbers a[0], a[1], a[2], a[3], a[4], a[5]
//  each one is unique and <= 6
//  a hidden list: 0x14c->0xa8->0x39c->0x2b3->0x1dd->0x1bb
//  use each 7 - a[i] as index to reorder the list
//  so that the list is sorted no increasingly
//  so 7 - a : 3 4 5 6 1 2
//  so input: 4 3 2 1 6 5 
00000000004010f4 <phase_6>:
  ...
  4010fa:	55                   	push   %rbp
  4010fb:	53                   	push   %rbx
  4010fc:	48 83 ec 50          	sub    $0x50,%rsp         //int a[6];
  401100:	49 89 e5             	mov    %rsp,%r13          //int* p = a;
  401103:	48 89 e6             	mov    %rsp,%rsi          //
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>
  40110b:	49 89 e6             	mov    %rsp,%r14          //read_six_numbers(input, a);
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d         //for(int i = 1; i < 6; ++i){
  
  401114:	4c 89 ed             	mov    %r13,%rbp          //  int* t = p;
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax     //  int x = *p;
  40111b:	83 e8 01             	sub    $0x1,%eax          
  40111e:	83 f8 05             	cmp    $0x5,%eax          //  if(x - 1 > 5) explode_bomb();
  ...
  401132:	44 89 e3             	mov    %r12d,%ebx         //  for(int j = i; j <= 5; ++j){
  401135:	48 63 c3             	movslq %ebx,%rax      
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax //    x = *(a + 4 * j); 
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)     //    if(x == *t) explode_bomb();
  40113e:	75 05                	jne    401145 <phase_6+0x51>
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx          //  }
  401148:	83 fb 05             	cmp    $0x5,%ebx          
  40114b:	7e e8                	jle    401135 <phase_6+0x41>
  40114d:	49 83 c5 04          	add    $0x4,%r13          //p += 4;
  401151:	eb c1                	jmp    401114 <phase_6+0x20>
                                                          //}
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi    //int* b = a + 24;
  401158:	4c 89 f0             	mov    %r14,%rax          //int* c = a;
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx          //int n = 7;
                                                          
  401160:	89 ca                	mov    %ecx,%edx          //for(int* p = a; p != b; p += 4){ 
  401162:	2b 10                	sub    (%rax),%edx        //  int x = 7;
  401164:	89 10                	mov    %edx,(%rax)        //  x -= *p;
  401166:	48 83 c0 04          	add    $0x4,%rax          //  *p = x;
  40116a:	48 39 f0             	cmp    %rsi,%rax          //}
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>
                                                          //  int* p = 0x6032d0;
  40116f:	be 00 00 00 00       	mov    $0x0,%esi          //  int i = 0;
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>//while(i != 24){
                                                            //  int x = *(a + i);
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx       //  p = 0x6032d0
  40117a:	83 c0 01             	add    $0x1,%eax            //  for(int j = 1; j < x; ++j){ 
  40117d:	39 c8                	cmp    %ecx,%eax            //    p = *((int**)(p + 8));
  40117f:	75 f5                	jne    401176 <phase_6+0x82>//}
  401181:	eb 05                	jmp    401188 <phase_6+0x94>

  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx        
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)// *(a + 2 * i + 32) = p;
  ...
  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx  //int* pre = *((int**)(a + 32));
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax  //int** cur = (int**)(a + 40);
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi  //int** end = (int**)(a + 80);
  4011ba:	48 89 d9             	mov    %rbx,%rcx        //while(cur != end){
  4011bd:	48 8b 10             	mov    (%rax),%rdx      //  int* p = *cur;
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)   //  *((int**)(pre + 8)) = p; 
  4011c4:	48 83 c0 08          	add    $0x8,%rax        //  cur += 8;
  4011c8:	48 39 f0             	cmp    %rsi,%rax        //  pre = p;
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>
  4011cd:	48 89 d1             	mov    %rdx,%rcx        //}
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>

  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)   //*((int**)(pre + 8)) = 0x0;
  4011d9:	00 
...
//int fun7(int* p, long x);
0000000000401204 <fun7>:
  401204:	48 83 ec 08          	sub    $0x8,%rsp
  401208:	48 85 ff             	test   %rdi,%rdi
  40120b:	74 2b                	je     401238 <fun7+0x34>   //if(p == 0) return 0xffffffff;
  40120d:	8b 17                	mov    (%rdi),%edx
  40120f:	39 f2                	cmp    %esi,%edx            //if(x < *p) return 2 * fun7(*(int**)(p + 8), x);
  ...
  401220:	b8 00 00 00 00       	mov    $0x0,%eax            //if(x == *p) return 0;
  401225:	39 f2                	cmp    %esi,%edx            
  401227:	74 14                	je     40123d <fun7+0x39>
  401229:	48 8b 7f 10          	mov    0x10(%rdi),%rdi      //if(x > *p) return 2 * fun7(*(int**)(p + 16), x) + 1;
...
//22
//  fun7 must return 2
//  notice the given address, form a binary searching tree
//  the path from root to x:
//  first, go left, second, go right  
//  then got 0x16(22), return 0
//  recall, 0 -> 1 -> 2
//  so x is 22
//                       0x24
//           0x8                     0x32
...
0000000000401242 <secret_phase>:
  ...
  40125a:	48 89 c3             	mov    %rax,%rbx          //long x = strtol(input, 0, 10);
  ...
  401273:	e8 8c ff ff ff       	callq  401204 <fun7>      //int res = fun7(0x6030f0, x);
  401278:	83 f8 02             	cmp    $0x2,%eax          //res ==  2
...
000000000040131b <string_length>:
  40131b:	80 3f 00             	cmpb   $0x0,(%rdi)  //if(*p == 0) return 0; 
  40131e:	74 12                	je     401332 <string_length+0x17>
  401320:	48 89 fa             	mov    %rdi,%rdx  //char* t = p;

  401323:	48 83 c2 01          	add    $0x1,%rdx  //t += 1;
  401327:	89 d0                	mov    %edx,%eax  
  401329:	29 f8                	sub    %edi,%eax  //len = t - p;
  40132b:	80 3a 00             	cmpb   $0x0,(%rdx)  //if(*t == 0) return len;
...
//int blank_line(char* p)
//return 1 if give a blank line and 0 else 
...
000000000040143a <explode_bomb>:
  ...
  401448:	bf ac 25 40 00       	mov    $0x4025ac,%edi //"the bomb has blown up"
  40144d:	e8 be f6 ff ff       	callq  400b10 <puts@plt>
  401452:	bf 08 00 00 00       	mov    $0x8,%edi
  401457:	e8 c4 f7 ff ff       	callq  400c20 <exit@plt>  //exit(8)
...
000000000040145c <read_six_numbers>:
  ...
  401494:	e8 a1 ff ff ff       	callq  40143a <explode_bomb>  //input number <= 5: game over
...
00000000004015c4 <phase_defused>:
  ...
  4015f5:	bf 70 38 60 00       	mov    $0x603870,%edi //the address of the 4th input
  4015fa:	e8 f1 f5 ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  4015ff:	83 f8 03             	cmp    $0x3,%eax  
  401602:	75 31                	jne    401635 <phase_defused+0x71>  //input numbers == 3
