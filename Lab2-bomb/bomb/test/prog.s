...
0000000000001169 <main>:
    ...
    1172:	bb 28 00 00 00       	mov    $0x28,%ebx
    1177:	64 48 8b 03          	mov    %fs:(%rbx),%rax
    117b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)
    1180:	31 c0                	xor    %eax,%eax
    1182:	48 89 e2             	mov    %rsp,%rdx
    1185:	be 03 00 00 00       	mov    $0x3,%esi
    ...
    11a9:	e8 c2 fe ff ff       	callq  1070 <__printf_chk@plt>
    11ae:	48 8b 44 24 08       	mov    0x8(%rsp),%rax
    11b3:	64 48 33 03          	xor    %fs:(%rbx),%rax
    11b7:	75 0b                	jne    11c4 <main+0x5b>
    11b9:	b8 00 00 00 00       	mov    $0x0,%eax
    11be:	48 83 c4 10          	add    $0x10,%rsp
    11c2:	5b                   	pop    %rbx
    11c3:	c3                   	retq   
    11c4:	e8 97 fe ff ff       	callq  1060 <__stack_chk_fail@plt>

00000000000011c9 <mult2>:
    11c9:	f3 0f 1e fa          	endbr64 
    11cd:	48 89 f8             	mov    %rdi,%rax
    11d0:	48 0f af c6          	imul   %rsi,%rax
    11d4:	c3                   	retq   
